...
export const HeroSection = () => {
  return (
    <div id="home" className='py-20 md:py-32 lg:py-40 relative z-0 overflow-x-clip'>
      ...
      <div className='max-w-lg mx-auto'>
        <h1 className='font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide'>Aspiring Systems Architect</h1>
        <p className='mt-4 text-center text-white/60 md:text-lg'>
        I am a Software Engineer at Wells Fargo, passionate about distributed systems, aiming to design scalable systems. As an aspiring systems architect, I want to combine hands-on engineering with systems thinking, supported by research in cybersecurity and parallel computing.
        </p>
      </div>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center mt-8 gap-4'>
        ...
        <a 
          href="https://drive.google.com/file/d/1VzjuPR353yQJQ43mqPttIqe6xMz9OCM_/view"
          target="_blank" 
          rel="noopener noreferrer"
